...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->enum('status', ['pending', 'preparing', 'enroute', 'failed', 'cancelled', 'delivered'])->nullable()->default('pending');
            $table->enum('payment_status', ['pending', 'failed', 'cancelled', 'successful'])->nullable()->default('pending');
